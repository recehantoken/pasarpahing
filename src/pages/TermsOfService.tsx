...
const TermsOfService = () => {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-3xl font-bold mb-6 text-center">Syarat dan Ketentuan</h1>
      ...
      <Card className="p-6 mb-8">
        <div className="prose max-w-none">
          ...
          <p className="mb-4">
            ...
            menyetujui untuk terikat oleh syarat dan ketentuan ini. Jika Anda tidak menyetujui semua syarat dan 
            ketentuan ini, Anda tidak boleh mengakses atau menggunakan layanan kami.
          </p>
          ...
          <ul className="list-disc pl-5 mb-4">
            ...
            <li><strong>"Anda", "Pengguna"</strong> mengacu pada individu atau entitas yang mengakses atau menggunakan Layanan kami.</li>
            <li><strong>"Pedagang"</strong> mengacu pada penjual yang menawarkan produk melalui platform Pasar Pahing.</li>
            <li><strong>"Konten"</strong> mengacu pada teks, grafik, gambar, audio, video, informasi, atau materi lain yang ditampilkan di platform.</li>
          </ul>
